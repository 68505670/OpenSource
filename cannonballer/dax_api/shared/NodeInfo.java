...
public class NodeInfo {
    ...
    private static final HashMap<Integer, HashMap<Integer, HashMap<Integer, Details>>> observableXMap = new HashMap<>();
    private static final HashMap<Integer, HashMap<Integer, HashMap<Integer, Details>>> pathTileXMap = new HashMap<>();
    private static HashMap<Integer, HashMap<Integer, HashMap<Integer, Details>>> realTime = new HashMap<>();
